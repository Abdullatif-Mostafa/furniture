...
function displayServices() {
    ...
    services.forEach(service => {
        ...
        <div class="services">
            ...
            <div>
                <button class="edit-button my-2" onclick="openEditModal(${service.id})"><a  href="servUpdate.html">تعديل</a></button>
                <button class="delete-button" onclick="openDeleteModal(${service.id})"><a  href="servDelete.html">حذف</a></button>
            <div>
        </div>
        `;
